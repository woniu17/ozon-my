...
// ── PDD 调试通道(2026-09-14,排查 cookie 采集问题用)──────────
// 独立 IIFE。原"PDD 登录同步双向桥"(ERP_BRIDGE_REQUEST/RESPONSE)已于
// 2026-09-15 移除——插件改为直连 ERP 后端 API,不再经页面桥同步。
// 保留调试入口:页面 postMessage {source:'erp-pdd-debug', type:'PDD_DEBUG_RUN'}
