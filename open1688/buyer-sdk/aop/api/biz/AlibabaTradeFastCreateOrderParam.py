...
class AlibabaTradeFastCreateOrderParam(BaseApi):
    ...
    def __init__(self, domain=None):
        ...
        self.useOfficialSolution = None
        self.useOfficialSolutionModelList = None
        self.fromAgent = None
    ...
    def get_required_params(self):
        return ['flow', 'subUserId', 'message', 'addressParam', 'cargoParamList', 'invoiceParam', 'isvBizTypeStr', 'isvBizTypeErp', 'isvBizTypePD', 'shopPromotionId', 'tradeType', 'encryptOutOrderInfo', 'instanceId', 'proxySettleRecordId', 'fenxiaoChannel', 'outOrderId', 'preSelectPayChannel', 'noUseRedEnvelope', 'useRedEnvelope', 'extendParam', 'useOfficialSolution', 'useOfficialSolutionModelList', 'fromAgent']
