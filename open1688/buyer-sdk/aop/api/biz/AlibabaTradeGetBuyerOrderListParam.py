...
class AlibabaTradeGetBuyerOrderListParam(BaseApi):
    ...
    def get_required_params(self):
        return ['bizTypes', 'createEndTime', 'createStartTime', 'isHis', 'modifyEndTime', 'modifyStartTime', 'orderStatus', 'page', 'pageSize', 'refundStatus', 'sellerMemberId', 'sellerLoginId', 'sellerRateStatus', 'tradeType', 'productName', 'needBuyerAddressAndPhone', 'needMemoInfo', 'outOrderId', 'needInvoicingSetting', 'orderIds']
