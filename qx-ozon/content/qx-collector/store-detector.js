// QX采集器 - 店铺检测区块
// 用于显示当前店铺的完整信息(名称/slug/sellerId/公司信息/国家/采集方式/中国状态),支持人工标记
(function () {
   ...
   * @param {object} state - {slug, name, sellerId, pageType, method, companyInfo, isChinese, classifiedBy}
  ...
  function renderStoreDetectionBlock(container, state) {
    ...
    if (state.isChinese === true || state.isChinese === false) {
      // 已分类:显示[重新分类]
