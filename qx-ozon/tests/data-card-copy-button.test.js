...
assert(sharedUtils.includes('window.jzSafeCopyText'), 'shared data cards should expose a safe clipboard helper');
assert(
...
assert(sharedBindCalls >= 2, 'both shared data-card renderers should bind copy buttons');
assert(
