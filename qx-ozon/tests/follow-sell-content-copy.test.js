...
const sourceVariant = {
  attributes: [{ key: '4191', value: 'Original source product description.' }],
};
...
assert.strictEqual(
  readSourceAttrText({ attributes: [{ key: '4191', value: '', values: [{ value: 'Values description.' }] }] }, '4191'),
  'Values description.'
);
...
assert.strictEqual(typeof shouldForceCollectRefresh, 'function', 'shouldForceCollectRefresh should be exported');
...
assert.deepStrictEqual(normalizeSourceHashtags([' case ', '#phone', 'case', '']), ['#case', '#phone']);
